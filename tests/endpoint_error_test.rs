...
async fn test_schema_columns_pool_error() {
    ...
    let res = app
        .oneshot(
            Request::builder()
                .uri("/api/schema/columns?table=test")
                .body(Body::empty())
                .unwrap(),
        )
        .await
...
async fn test_schema_sample_pool_error() {
    ...
    let res = app
        .oneshot(
            Request::builder()
                .uri("/api/schema/sample?table=valid_table")
                .body(Body::empty())
                .unwrap(),
        )
        .await
...
async fn test_sales_customer_detail_pool_error() {
    ...
    let res = app
        .oneshot(
            Request::builder()
                .uri("/api/sales/customer-detail?code=000001")
                .body(Body::empty())
                .unwrap(),
        )
        .await
...
async fn test_schema_sample_invalid_table_name() {
    ...
    let res = app
        .oneshot(
            Request::builder()
                .uri("/api/schema/sample?table=foo;DROP%20TABLE")
                .body(Body::empty())
                .unwrap(),
        )
        .await
...
async fn test_schema_sample_ok() {
    ...
    let res = app
        .oneshot(
            Request::builder()
                .uri("/api/schema/sample?table=test_table&limit=5")
                .body(Body::empty())
                .unwrap(),
        )
        .await
...
async fn test_sales_monthly_ok() {
    ...
    let res = app
        .oneshot(
            Request::builder()
                .uri("/api/sales/monthly?from=2025-04&to=2026-03")
                .body(Body::empty())
                .unwrap(),
        )
        .await
...
async fn test_sales_by_customer_ok() {
    ...
    let res = app
        .oneshot(
            Request::builder()
                .uri("/api/sales/by-customer?limit=10")
                .body(Body::empty())
                .unwrap(),
        )
        .await
...
async fn test_sales_daily_ok() {
    ...
    let res = app
        .oneshot(
            Request::builder()
                .uri("/api/sales/daily?month=2025-04&mode=billing")
                .body(Body::empty())
                .unwrap(),
        )
        .await
...
async fn test_sales_daily_with_exclude_dept() {
    ...
    let res = app
        .oneshot(
            Request::builder()
                .uri("/api/sales/daily?month=2025-04&exclude_dept=宮崎")
                .body(Body::empty())
                .unwrap(),
        )
        .await
...
async fn test_sales_customer_yoy_ok() {
    ...
    let res = app
        .oneshot(
            Request::builder()
                .uri("/api/sales/customer-yoy?from=2025-04&to=2026-03")
                .body(Body::empty())
                .unwrap(),
        )
        .await
...
async fn test_sales_customer_yoy_by_dept_ok() {
    ...
    let res = app
        .oneshot(
            Request::builder()
                .uri("/api/sales/customer-yoy-by-dept?from=2025-04&to=2026-03")
                .body(Body::empty())
                .unwrap(),
        )
        .await
...
async fn test_sales_customer_yoy_by_dept_with_department_code_ok() {
    ...
    let res = app
        .oneshot(
            Request::builder()
                .uri("/api/sales/customer-yoy-by-dept?from=2025-04&to=2026-03&department_code=01")
                .body(Body::empty())
                .unwrap(),
        )
        .await
