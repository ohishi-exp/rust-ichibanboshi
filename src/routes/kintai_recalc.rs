    ...
    let gate = match gate.map_err(map_push_err)? {
        crate::kintai_fold::MonthGate::Hit(mut report) => {
            ...
            return Ok(Json(serde_json::json!({
                ...
                "unko_diff_gcp_only_in_month_by_vehicle": unko_diff.gcp_only_in_month_by_vehicle,
                "unko_diff_gcp_only_in_month_unknown_vehicle": unko_diff.gcp_only_in_month_unknown_vehicle,
